            ...
            <div className="cycles-svg-container" aria-hidden="true">
              ...
              >
                ...
                <ellipse
                  ...
                  rx="200"
                  ry="90"
                  stroke={activeCycleIndex >= 1 ? '#DD0060' : 'rgba(255,255,255,0.08)'}
                ...
                <circle cx="300" cy="160" r="14" fill="#07101C" stroke="#DD0060" strokeWidth="2" />
                <circle cx="300" cy="160" r="4" fill="#DD0060" />
                ...
                <circle cx="100" cy="160" r="5" fill="#DD0060" />
                <circle cx="500" cy="160" r="5" fill="#DD0060" />
                <circle cx="40" cy="160" r="6" fill="#DD0060" />
                <circle cx="560" cy="160" r="6" fill="#DD0060" />
              </svg>
            </div>
