      ...
      <div className="approach-sticky-viewport">
        ...
        <div className="approach-workspace-canvas">
          ...
          <svg className="workspace-conduit-svg" viewBox="0 0 1000 600" fill="none" preserveAspectRatio="none">
            ...
            />
            {activeStageIdx >= 1 && (
              <line x1="240" y1="220" x2="240" y2="340" stroke="#C58A3A" strokeWidth="2.5" />
            )}
            {activeStageIdx >= 2 && (
              <line x1="380" y1="200" x2="550" y2="280" stroke="#C58A3A" strokeWidth="2.5" />
            )}
            {activeStageIdx >= 3 && (
              <line x1="550" y1="360" x2="720" y2="380" stroke="#C58A3A" strokeWidth="2.5" />
            )}
            {activeStageIdx >= 4 && (
              <circle cx="500" cy="300" r="80" stroke="#C58A3A" strokeWidth="2" strokeDasharray="8 4" className="core-flywheel-ring" />
            )}
          </svg>
          ...
          >
            <div className="artifact-media-frame">
              ...
              <div className="artifact-meta-pill">
                <span className="status-ping-dot" style={{ backgroundColor: '#C58A3A' }} />
