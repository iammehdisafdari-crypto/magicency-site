...
export const BLOG_ARTICLES = [
  {
    ...
    authorEn: 'Mehdi Safdari // Strategy Director',
    authorFa: 'مهدی صفدری // مدیر استراتژی',
  ...
  },
  {
    ...
    authorEn: 'Magicency Creative Studio',
    authorFa: 'استودیو خلاقیت مجیکنسـی',
  ...
  },
  {
    ...
    authorEn: 'Magicency Digital Architecture',
    authorFa: 'معماری دیجیتال مجیکنسـی',
  ...
  },
  {
    ...
    authorEn: 'Magicency Performance Lab',
    authorFa: 'آزمایشگاه پرفورمنس مجیکنسـی',
  ...
  },
  {
    ...
    readTime: '6 MIN READ',
    readTimeFa: '۶ دقیقه مطالعه',
    authorEn: 'Magicency Strategy Group',
    authorFa: 'گروه استراتژی مجیکنسـی',
